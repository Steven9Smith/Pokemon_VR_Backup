...
*/
	...
	#pragma warning restore 618
		...
		float3 linearVelocity, float3 angularVelocity, float mass, bool isDynamic, UnityEngine.Material material,Mesh org_mesh = null)
		{
		...
		protected static Entity CreateStaticBody(float3 position, quaternion orientation, BlobAssetReference<Collider> collider,UnityEngine.Material material,Mesh org_mesh = null)
		{
			return CreateBody(position, orientation, collider, float3.zero, float3.zero, 0.0f, false,material,org_mesh);
		}
		...
		public static Entity CreateTerrain(EntityManager entityManager, NativeArray<float> heights,
			...
			Unity.Physics.TerrainCollider.CollisionMethod method = Unity.Physics.TerrainCollider.CollisionMethod.VertexSamples,Mesh org_mesh = null)
		{
			...
			return CreateStaticBody(position, quaternion.identity, collider,material,org_mesh);
		}
