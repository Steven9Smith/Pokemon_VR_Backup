...
namespace Core.GameConfig
{
	public static class GameConfigClass
	{
		...
		public static void LoadGameConfig(bool reset = false, bool reload = false)
		{
			...
			if(gameConfig.Equals(new GameConfig { }))LoadGameConfig(false, false);
		...
		public static PlayerInputConfig GetPlayerInputConfig(PlayerInputConfigs pic,int player = 0)
		{
			switch (player)
			{
				case 1: return pic.Player1;
				case 2: return pic.Player2;
				case 3: return pic.Player3;
				case 4: return pic.Player4;
				default:
					Debug.LogError("System Currently does not support more than 4 players");
					return pic.Player1;
			}
		}
