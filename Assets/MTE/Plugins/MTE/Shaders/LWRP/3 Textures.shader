    ...
    SubShader
    {
        ...
        Pass
        {
        	...
        	half4 frag (GraphVertexOutput IN  ) : SV_Target
            {
				...
				float4 weightedAvg4 = ( ( weightedBlendVar4.x*tex2D( _Splat0, uv0_Splat0 ) + weightedBlendVar4.y*tex2D( _Splat1, uv0_Splat1 ) + weightedBlendVar4.z*tex2D( _Splat2, uv0_Splat2 ) + weightedBlendVar4.w*float4( 0,0,0,0 ) )/( weightedBlendVar4.x + weightedBlendVar4.y + weightedBlendVar4.z + weightedBlendVar4.w ) );
				
				float4 weightedBlendVar17 = tex2DNode6;
				float3 weightedAvg17 = ( ( weightedBlendVar17.x*UnpackNormalScale( tex2D( _Normal0, uv0_Splat0 ), 1.0f ) + weightedBlendVar17.y*UnpackNormalScale( tex2D( _Normal1, uv0_Splat1 ), 1.0f ) + weightedBlendVar17.z*UnpackNormalScale( tex2D( _Normal4, uv0_Splat2 ), 1.0f ) + weightedBlendVar17.w*float3( 0,0,0 ) )/( weightedBlendVar17.x + weightedBlendVar17.y + weightedBlendVar17.z + weightedBlendVar17.w ) );
				
				float4 appendResult62 = (float4(_Metallic0 , _Metallic1 , _Metallic2 , 0.0));
				float dotResult63 = dot( tex2DNode6 , appendResult62 );
				
				float4 appendResult65 = (float4(_Smoothness0 , _Smoothness1 , _Smoothness2 , 0.0));
...
/*ASEBEGIN
Version=17101
15;35;1854;732;3950.735;1553.576;3.77308;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;53;-1125.719,-719.2783;Float;False;Property;_Metallic0;Metallic 1;7;0;Create;False;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;39;-1130.471,-218.6033;Inherit;True;Property;_Normal1;Normalmap 2;5;0;Create;False;0;0;False;0;None;2bfa6ce6a05caeb4f84f99e403361842;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;57;-1127.09,78.72269;Float;False;Property;_Smoothness1;Smoothness 2;11;0;Create;False;0;0;False;0;0.5;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;16;-1131.163,-929.2997;Inherit;True;Property;_Normal0;Normalmap 1;4;0;Create;False;0;0;False;0;None;4d6323c1fc1635443912c9a55a30b876;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;56;-1129.219,-13.69413;Float;False;Property;_Metallic1;Metallic 2;8;0;Create;False;0;0;False;0;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;44;-1124.177,487.4503;Inherit;True;Property;_Normal4;Normalmap 3;6;0;Create;False;0;0;False;0;None;5371771cfb5e7b649973b3d535b71e5d;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;59;-1113.205,792.0283;Float;False;Property;_Smoothness2;Smoothness 3;12;0;Create;False;0;0;False;0;0.5;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;54;-1123.59,-626.8615;Float;False;Property;_Smoothness0;Smoothness 1;10;0;Create;False;0;0;False;0;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;58;-1115.334,699.6114;Float;False;Property;_Metallic2;Metallic 3;9;0;Create;False;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;443.5355,60.77441;Float;False;True;2;ASEMaterialInspector;0;2;MTE/LWRP/3 Textures;1976390536c6c564abb90fe41f6ee334;True;Base;0;0;Base;11;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=LightweightPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=-100;True;2;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=LightweightForward;False;0;;0;0;Standard;3;Vertex Position,InvertActionOnDeselection;1;Receive Shadows;1;LOD CrossFade;1;1;_FinalColorxAlpha;0;4;True;True;True;True;False;0
...
ASEEND*/
//CHKSM=229AFC53F850785A02777DEFD0BD83E86506E443